      ...
      <div>
        <div className={"bg-light-gray-secondary p-5 mt-5"}>
          ...
          <p>
            ...
            lenger er i stand til å ivareta sine interesser innen de områdene
            som omfattes av fullmakten.»
          </p>
        </div>

        <div className={"bg-light-gray-secondary p-5 mt-5"}>
          <h2 className={"font-bold"}>
            Noen forklaringer det er greit å ha med seg
          </h2>
          <br />
          <p>
          ...
          <br />
          <p>
            Å gi noen en fremtidsfullmakt vil si at personen eller personene som
            får en slik fullmakt vil kunne disponere rettslig på et tidspunkt i
            fremtiden når visse forutsetninger inntreffer.
          </p>
          <br />
          <p>
            Den som gir noen en fullmakt kalles fullmaktsgiver, og den som får
            en fullmakt er fullmektig.
          </p>
          <br />
          <p>
            Det er to typer fremtidsfullmakter, hvor den ene er fullmakt på det
            økonomiske området som skal tre i kraft fra opprettelsen eller et
            annet tidspunkt og før fullmaktsgiveren har mistet handleevnen.
            Deretter skal fullmakten fortsett å gjelde etter at handleevnen er
            tapt (vedvarende fullmakter).
          </p>
          <br />
          <p>
